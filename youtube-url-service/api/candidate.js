...
module.exports.submit = (requestBody, context, callback) => {
console.log("🚀 ~ file: candidate.js ~ line 11 ~ event", requestBody)
  ...
  submitCandidateP(candidateInfo(fullname, email, experience,context.awsRequestId))
    .then(res => {
      callback(null, {
        statusCode: 200,
        body: JSON.stringify({
...
console.log("🚀 ~ file: candidate.js ~ line 45 ~ candidate", candidate)
...
const candidateInfo = (fullname, email, experience, uniqueId) => {
console.log("🚀 ~ file: candidate.js ~ line 56 ~ candidateInfo ~ uniqueId", uniqueId)
